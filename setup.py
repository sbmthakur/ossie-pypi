...
setup(
  name = 'sossy',         # How you named your package folder (MyLib)
  packages = ['sossy'],   # Chose the same as "name"
  version = '0.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Sossy detects "risky" Python PyPi packages in your software supply chain',   # Give a short description about your library
  author = 'Ossillate Inc.',                   # Type in your name
  author_email = 'oss@ossillate.com',      # Type in your E-Mail
  url = 'https://github.com/ossillate-inc/sossy-pypi',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/ossillate-inc/sossy-pypi/archive/refs/tags/placeholder.tar.gz', # I explain this later on
